  ...
  <div class="login-html">
    ...
    <div class="login-form">
      ...
      <form class="sign-up-htm">
        ...
        <div class="group">
          <label for="pass" class="label">Пароль еще раз</label>
          <input id="pass" name="passwordcopy" type="password" class="input" data-type="password">
        </div>
        <div class="group">
...
.login-wrap{
  ...
  margin: 50px auto;
	position:relative;
	background: url(https://tvernews.ru/uploads/6fmEvSsHiIlSTZUvc7nJhq4myIN02D.jpg)  no-repeat center;
	box-shadow:0 12px 15px 0 rgba(215, 178, 178, 0.24),0 17px 50px 0 rgba(0,0,0,.19);
}
.login-html{
	width:100%;
	height:100%;
	...
	background:rgba(100, 106, 123, 0.9);
}
